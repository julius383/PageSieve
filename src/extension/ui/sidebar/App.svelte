<script lang="ts">
    import ActionBar from '@/extension/ui/sidebar/components/ActionBar.svelte';
    import SavedLibrary from '@/extension/ui/sidebar/components/SavedLibrary.svelte';
    import ResultsViewer from '@/extension/ui/sidebar/components/ResultsViewer.svelte';
    import ConfigPanel from '@/extension/ui/sidebar/components/ConfigPanel.svelte';
    import FieldConstructor from '@/extension/ui/sidebar/components/FieldConstructor.svelte';

    import StatusIndicator from '@/extension/ui/sidebar/components/StatusIndicator.svelte';
    import LogViewer from '@/extension/ui/sidebar/components/LogViewer.svelte';
