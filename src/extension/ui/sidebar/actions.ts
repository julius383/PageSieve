...
import { commitPaginationToScrapeConfig } from '@/extension/ui/sidebar/stores/pagination.svelte';
import { type ExtractedGroup, PaginationStateStatus } from '@/core/types';
