<script lang="ts">
    ...
    import { allConfigs, refreshConfigs } from '@/extension/ui/sidebar/stores/ui.svelte';
    import { loadConfig } from '@/extension/ui/sidebar/actions';
    import { renameConfig, removeConfig } from '@/extension/ui/sidebar/services/storage';
