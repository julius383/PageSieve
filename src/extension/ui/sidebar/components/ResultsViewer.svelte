<script lang="ts">
    ...
    import DataTable from '@/extension/ui/sidebar/components/DataTable.svelte';

    import type { SupportedExportDataTypes } from '@/core/types';

    import { downloadBundle, clipboardCopy, downloadFormat } from '@/extension/ui/sidebar/util';

    import { extractedData, resetExtractedData } from '@/extension/ui/sidebar/stores/ui.svelte';
    import { saveResults, getLatestResults, saveLogs } from '@/extension/ui/sidebar/services/storage';
    import { logStore } from '@/extension/ui/sidebar/stores/logs';
