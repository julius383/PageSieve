<script lang="ts">
    ...
    import { scrapeConfig } from '@/extension/ui/sidebar/stores/scrapeConfig.svelte';
    import { paginationState, commitPaginationToScrapeConfig } from '@/extension/ui/sidebar/stores/pagination.svelte';
    import { Navigation } from '@lucide/svelte';
    import { navigateTo } from '@/extension/ui/sidebar/actions';
