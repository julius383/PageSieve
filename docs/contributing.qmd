...
3. Start the build process: `bun run build:extension` (for production)

## Build Commands

- `bun run build:extension`: Generates the production extension in the `dist/` folder.
...
- `just build-extension`: Build the extension.
